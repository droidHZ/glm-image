...
> Generate content using the Z Image model

## Overview

This document describes how to use the Z Image model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `z-image` |
...
|----------|-------|-------------|
| **Format** | `z-image` | The exact model identifier for this API |
...
- **Default Value**: `"A hyper-realistic, close-up portrait of a 30-year-old mixed-heritage French-Italian woman drinking coffee from a cup that says “Z-Image × Kie AI.” Natural light. Shot on a Leica M6 with a Kodak Portra 400 film-grain aesthetic."`
...
```json
{
  ...
  "data": {
    ...
    "model": "z-image",
    "state": "waiting",
    "param": "{\"model\":\"z-image\",\"input\":{\"prompt\":\"A hyper-realistic, close-up portrait of a 30-year-old mixed-heritage French-Italian woman drinking coffee from a cup that says “Z-Image × Kie AI.” Natural light. Shot on a Leica M6 with a Kodak Portra 400 film-grain aesthetic.\",\"aspect_ratio\":\"1:1\"}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1765183072709_QZy779j9.png\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
